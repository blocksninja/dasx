...
QT_TRANSLATE_NOOP("dash-core", "Copyright (C) 2014-%i The Das Core Developers"),
...
QT_TRANSLATE_NOOP("dash-core", "Error loading wallet.dat: Wallet requires newer version of Das Core"),
...
QT_TRANSLATE_NOOP("dash-core", "Initialization sanity check failed. Das Core is shutting down."),
...
QT_TRANSLATE_NOOP("dash-core", "Keep N DAS anonymized (default: %u)"),
...
QT_TRANSLATE_NOOP("dash-core", "Wallet needed to be rewritten: restart Das Core to complete"),
